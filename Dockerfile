...
CMD ["gunicorn", "-b", "0.0.0.0:8080", "-w", "3", "--threads=2", "-k", "gthread", "-t", "60", "--pid", "gunicorn.pid", "--worker-tmp-dir", "/dev/shm", "--preload", "--config", "python:cubedash.gunicorn_config", "cubedash:app"]
